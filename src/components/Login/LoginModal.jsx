    ...
    try {
      if (view === 'signup') {
        ...
        if (!namePattern.test(formData.firstName)) {
          setMessage('First name should not contain numbers or special characters.');
          toast.error('First name should not contain numbers or special characters.');
          return;
        }

        // Validate last name
        if (!namePattern.test(formData.lastName)) {
          setMessage('Last name should not contain numbers or special characters.');
